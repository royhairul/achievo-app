        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="{{ route('penyelenggaraIndexRoute') }}"
                    class="flex items-center p-2 {{ $type == 'dashboard' ? 'text-sky-500 bg-sky-50' : 'text-sky-950' }} rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="{{ route('penyelenggaraLombaRoute') }}"
                    class="flex items-center p-2 {{ $type == 'lomba' ? 'text-sky-500 bg-sky-50' : 'text-sky-950' }} rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href=""
                    class="flex items-center p-2 {{ $type == 'users' ? 'text-sky-500 bg-sky-50' : 'text-sky-950' }} rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href=""
                    class="flex items-center p-2 {{ $type == 'product' ? 'text-sky-500 bg-sky-50' : 'text-sky-950' }} rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-sky-950 dark:group-hover:text-white"
