    ...
    <div class="flex min-h-full w-full lg:w-2/3 flex-col justify-center px-6 py-12 lg:px-8 bg-rose">
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            @if (isset(request()->message))
                <p class="my-2 p-2 border-2 rounded-md bg-amber-500/5 border-amber-500/15 text-amber-500">
                    {{ request('message') }}
                </p>
            @endif
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" action="{{ route('loginPostRoute') }}" method="POST">
                ...
                <div>
                    ...
                    <div>
                        <input id="username" name="username" type="text" value="{{ old('username') }}" class=" relative block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6
                ...
                <div>
                    ...
                    <div>
                        <input id="password" name="password" type="password" autocomplete="current-password"
                            value="{{ old('password') }}" class="relative block w-full rounded-md border-0 px-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6
