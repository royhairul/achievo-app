...
@section('content')
    <div class="wrapper">
        ...
        <div
            class="px-5 lg:px-24 mt-5 lg:mt-10 py-10 bg-gradient-to-r from-75% from-sky-950 to-sky-700 flex flex-col gap-y-4">
            ...
            <div class="flex gap-2">
                <span class="badge badge-neutral rounded-md bg-sky-900 text-sky-500">
                    Lomba Catur
                </span>
        ...
        <div class="px-5 lg:px-24 py-5 lg:py-10">
                            ...
                            @foreach ($daftarLomba as $item)
                                <div class="group relative flex flex-col justify-between">
                                    <a href="{{ route('lombaDetailRoute', ['id' => $item->lomba_id]) }}"
                                        ...
                                        <img src="{{ asset('images/' . $item->lomba_poster) }}"
