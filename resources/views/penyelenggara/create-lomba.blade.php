    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 pt-8 rounded-lg mt-14 gap-8">
            ...
            <div class="mt-5 w-3/4">
                <form class="grid grid-cols-1 sm:grid-cols-2 gap-5" action="{{ route('penyelenggaraStoreLombaRoute') }}"
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input id="name" name="name" type="text" autocomplete="name"
                                value="{{ old('name') }}" placeholder="Masukkan Nama Lomba..."
                        ...
                        <div class="mt-2">
                            <input datepicker datepicker-format="dd-mm-yyyy" id="date" name="date"
                                ...
                                @error('date')
                                    ring-rose-600
                                @enderror"
                                min="{{ \Carbon\Carbon::now()->addDays(2)->format('Y-m-d') }}" required>
                        </div>
                        @error('date')
                            <p class="absolute text-sm text-rose-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input
                            ...
                            aria-describedby="file-upload_help" id="file-upload" name="image" type="file">
                        @error('image')
                            <p class="absolute text-sm text-rose-600">{{ $message }}</p>
                        @enderror
                    </div>
