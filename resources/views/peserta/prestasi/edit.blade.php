        ...
        <div class="px-6">
            <div class="p-4 rounded-lg mt-4 gap-3">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <div class="mb-2">
                            <h2 class="text-sky-800 font-bold text-xl">Edit Prestasi</h2>
                        </div>
                        <div class="mb-4">
                ...
                <form method="POST" action="{{ route('pesertaUpdatePrestasiRoute', $prestasi->prestasi_id) }}"
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input id="nama" name="nama" type="text" autocomplete="nama"
                                value="{{ $prestasi->prestasi_lomba }}" placeholder="Masukkan Nama Lomba..."
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input id="peringkat" name="peringkat" type="text" autocomplete="peringkat"
                                value="{{ $prestasi->prestasi_peringkat }}" placeholder="Masukkan Juara 1, Juara 3..."
                                class="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6
                                        @error('peringkat')
                                            ring-rose-600
                                        @enderror">
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input id="nomor" name="nomor" type="text" autocomplete="nomor"
                                value="{{ $prestasi->prestasi_nomor }}" placeholder="Masukkan Nomor Sertifikat..."
                                class="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6
                                        @error('nomor')
                                            ring-rose-600
                                        @enderror">
                    ...
                    <div>
                        <label class="block text-sm font-medium leading-6 text-sky-950" for="file-upload">Upload Bukti
                            (Sertifikat)</label>
                        @if (isset($prestasi->prestasi_bukti))
                            <img src="{{ asset('images/' . $prestasi->prestasi_bukti) }}" alt="">
                        @endif
                        <input
