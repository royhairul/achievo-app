...
<div class="container h-screen flex">
    ...
    <div class="mt-10 w-3/4">
        ...
        <div>
            ...
            <div class="mt-2">
            <input id="fullname" name="fullname" type="fullname" autocomplete="fullname" placeholder="Masukkan Nama Anda..." required
        ...
        <div class="col-span-2">
            <button type="submit" class="flex w-full justify-center rounded-md bg-sky-500 py-2 text-base font-semibold leading-6 text-white shadow-sm hover:bg-sky-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600 transition-all ease-in-out duration-100">
            Buat Akun
            </button>
        </div>
        </form>
